...
A popular example of a Web Crawling framework is Scrapy, https://scrapy.org/. Definately check it out if you want to gain a deeper understanding of Web Scraping and have a play with it yourself.
